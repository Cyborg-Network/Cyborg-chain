...
```sh
./target/release/cyborg-node -h
```

You can generate and view the [Rust Docs](https://doc.rust-lang.org/cargo/commands/cargo-doc.html) with this command:
...
```sh
./target/release/cyborg-node purge-chain --dev
```

To start the development chain with detailed logging, run the following command:

```sh
RUST_BACKTRACE=1 ./target/release/cyborg-node -ldebug --dev
```
...
$ ./target/release/cyborg-node --dev --base-path ./my-chain-state/
